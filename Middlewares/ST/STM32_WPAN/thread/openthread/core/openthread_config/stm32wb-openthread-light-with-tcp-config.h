...
#define OPENTHREAD_CONFIG_PLATFORM_INFO "STM32WB V1.3.0 Thread_Light with TCP"
 ...
 * @def CFG_FW_BRANCH
 *
 * Overcharge value defined in general_config.h and set specific version.
 * 'With TCP' version should have an odd number, while 'no TCP' version should be even.
 *
 */
#undef CFG_FW_BRANCH
#define CFG_FW_BRANCH             								(1)
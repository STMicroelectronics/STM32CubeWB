...
typedef enum
{
  ...
  /* OT 1.4 additions */
  MSG_M4TOM0_OT_LINK_GET_ALT_SHORT_ADDRESS,
  MSG_M4TOM0_OT_THREAD_GET_ATTACH_DURATION,
  MSG_M4TOM0_OT_COAP_MESSAGE_APPEND_URI_QUERY_OPTIONS,
  /* BORDER AGENT OT 1.4 additions */
  MSG_M4TOM0_OT_BORDER_AGENT_INIT_SESSION,
  MSG_M4TOM0_OT_BORDER_AGENT_NEXT_SESSION,
  MSG_M4TOM0_OT_BORDER_AGENT_COUNTERS,

  /* Vendor Info Set APIs */
  MSG_M4TOM0_OT_THREAD_SET_VENDOR_NAME,
  MSG_M4TOM0_OT_THREAD_SET_VENDOR_MODEL,
  MSG_M4TOM0_OT_THREAD_SET_VENDOR_SW_VERSION,
  MSG_M4TOM0_OT_THREAD_SET_VENDOR_APP_URL,

  MSG_M4ToM0_RADIO_GET_CSL_ACCURACY,
  MSG_M4ToM0_RADIO_GET_CSL_UNCERTAINITY,
  
  MSG_M4ToM0_OT_THREAD_GET_NON_PREFERED_CHANNEL,
  MSG_M4ToM0_OT_THREAD_SET_NON_PREFERED_CHANNEL,
  
  MSG_M4ToM0_OT_DNS_CLIENT_QUERY_RECORD,
  MSG_M4ToM0_OT_DNS_RECORD_RESPONSE_GET_QUERY_NAME,
  MSG_M4ToM0_OT_DNS_RECORD_RESPONSE_GET_RECORD_INFO

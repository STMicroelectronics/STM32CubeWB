...
//#define HAL_HSEMA_MODULE_ENABLED
...
/**
  ...
  */
  ...
  #define HSI48_VALUE    ((uint32_t)4800000) /*!< Value of the Internal oscillator in Hz*/
#endif /* HSI48_VALUE */   

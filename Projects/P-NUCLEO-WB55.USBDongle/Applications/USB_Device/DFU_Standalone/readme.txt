...
In this application, two operating modes are available:
 ...
 2. Run-time application mode:
    This is the normal run-time activities. A binary which toggles LED1 on the NUCLEO-WB55.USBDongle board is
    provided in Binary directory.

@note After each device reset (unplug the NUCLEO-WB55.USBDongle board from PC), Plug the NUCLEO-WB55.USBDongle board with Key User push-button (SW1) button
...
@note A binary which toggles LED1 on the NUCLEO-WB55.USBDongle board is provided in Binary directory.
...
@par Hardware and Software environment
  ...
  - This application has been tested with STMicroelectronics NUCLEO-WB55.USBDongle
  ...
  - NUCLEO-WB55.USBDongle board Set-up
    ...
    - Connect the NUCLEO-WB55.USBDongle board to the PC.

...
@par Directory contents 
  ...
  - BLE/BLE_p2pServer/Core/Inc/app_conf.h                  Application configuration file for STM32WPAN Middleware
  - BLE/BLE_p2pServer/Core/Inc/app_debug.h                 Header for app_debug.c module
  - BLE/BLE_p2pServer/Core/Inc/app_entry.h                 Interface to the application
  - BLE/BLE_p2pServer/Core/Inc/hw_conf.h                   Configuration file of the HW
  - BLE/BLE_p2pServer/Core/Inc/hw_if.h                     Hardware Interface
  ...
  - BLE/BLE_p2pServer/Core/Inc/stm32_lpm_if.h              Header for stm32_lpm_if.c module (device specific LP management)
  - BLE/BLE_p2pServer/Core/Inc/utilities_conf.h            Configuration file of the utilities
  - BLE/BLE_p2pServer/Core/Inc/vcp_conf.h                  Configuration of the vcp interface
  ...
  - BLE/BLE_p2pServer/Core/Src/stm32wbxx_hal_msp.c         This file provides code for the MSP Initialization and de-Initialization
...
On the other STM32WB board, (MB1355C & MB1293C) for example:
...
Second demonstration
 ...
 - Then, it automatically connects to the BLE_p2pServer.
   ...
   - The SW1 event, switch on/off blue led, depends on this advertising event. 

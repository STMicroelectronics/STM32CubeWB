/**
  @page Zigbee_MeterId_Server_Coord application
  
  @verbatim
  ******************************************************************************
  * @file    Zigbee/Zigbee_MeterId_Server_Coord/readme.txt 
  * @author  MCD Application Team
  * @brief   Description of the Zigbee Meter Identification Cluster application as a server  
...
@par Hardware and Software environment
  ...
  - For the Zigbee_MeterId_Server_Coord application, a STM32WB55xx Nucleo can be used.

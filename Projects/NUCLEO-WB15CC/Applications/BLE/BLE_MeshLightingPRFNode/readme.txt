...
@par Hardware and Software environment
  ...
  - This application has been tested with an STMicroelectronics STM32WB15RCC-Nucleo
...
In order to make the program work, you must do the following:
 - Open your preferred toolchain (with STM32CubeIDE, only the GNU Tools for STM32 versions from the 10.3-2021.10 are supported)

...
to transfer data from memory to TIMER Capture Compare Register 3 (TIMx_CCR3).
  ...
  The following configuration values are used in this example:
    ...
    - SystemCoreClock is set to 64 MHz for STM32WBxx
...
@par Directory contents
  ...
  - TIM/TIM_DMA/Inc/stm32wbxx_hal_conf.h    HAL configuration file
  - TIM/TIM_DMA/Inc/stm32wbxx_it.h          Interrupt handlers header file
  - TIM/TIM_DMA/Inc/main.h                  Header for main.c module  
  - TIM/TIM_DMA/Src/stm32wbxx_it.c          Interrupt handlers
  - TIM/TIM_DMA/Src/main.c                  Main program
  - TIM/TIM_DMA/Src/stm32wbxx_hal_msp.c     HAL MSP file
  - TIM/TIM_DMA/Src/system_stm32wbxx.c      STM32WBxx system source file
...
@par Hardware and Software environment
  ...
  - P-NUCLEO-WB55 Set-up
    ...
    - TIM1 CH3 (PA.10 (pin 31 in CN10 connector))

...
The User push-button (SW1) is used to initiate a communication between Master device to Slave.
...
On Master board side:
 - Wait User push-button (SW1) to be pressed.
...
P-NUCLEO-WB55 board's LEDs can be used to monitor the transfer status in both side:
Slave board side :
 - LED2 is turned ON when the reception process is completed.
...
@par Directory contents 
  ...
  - I2C/I2C_TwoBoards_RestartAdvComIT/Inc/stm32wbxx_hal_conf.h    HAL configuration file
  - I2C/I2C_TwoBoards_RestartAdvComIT/Inc/stm32wbxx_it.h          I2C interrupt handlers header file
  - I2C/I2C_TwoBoards_RestartAdvComIT/Inc/main.h                  Header for main.c module  
  - I2C/I2C_TwoBoards_RestartAdvComIT/Src/stm32wbxx_it.c          I2C interrupt handlers
  - I2C/I2C_TwoBoards_RestartAdvComIT/Src/main.c                  Main program
  - I2C/I2C_TwoBoards_RestartAdvComIT/Src/system_stm32wbxx.c      STM32WBxx system source file
  - I2C/I2C_TwoBoards_RestartAdvComIT/Src/stm32wbxx_hal_msp.c     HAL MSP file    
...
@par Hardware and Software environment
  ...
  - Press User push-button (SW1) to initiate a communication by Master device to Slave device.
    User can initiate a new communication after each previous transfer completed.

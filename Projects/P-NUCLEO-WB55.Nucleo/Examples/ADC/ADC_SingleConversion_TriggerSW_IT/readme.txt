...
How to use the ADC to convert a single channel at each software start. This example
...
Board settings:
 ...
 - The voltage input on ADC channel must be provided by an external source connected to Arduino connector CN10 pin A2, Morpho connector CN9 pin 32.


To observe voltage level applied on ADC channel through GPIO, connect a voltmeter on
pin PA1 (Arduino connector CN10 pin A2, Morpho connector CN9 pin 32).

...
MSI as clock source, the User push-button (SW1) (connected to External line 4) will be
used to change the PLL source:
- from HSE to HSI
- from HSI to MSI
- from HSE to HSI

Each time the User push-button (SW1) is pressed External line 4 interrupt is generated and in the ISR

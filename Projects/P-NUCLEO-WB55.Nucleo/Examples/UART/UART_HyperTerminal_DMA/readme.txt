...
@par Hardware and Software environment
  ...
  - P-NUCLEO-WB55 Set-up
     - Connect USART1 TX (PB.06 (Pin 34 in CN10)) to RX pin of PC serial port (or USB to UART adapter)
       and USART1 RX (PB.07 (Pin 6 in CN10)) to TX pin of PC serial port (or USB to UART adapter).

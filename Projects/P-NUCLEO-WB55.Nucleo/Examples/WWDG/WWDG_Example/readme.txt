...
before writing again counter. Hence the WWDG counter is refreshed each 24,57 ms in the
...
occurs by pressing the User push-button (SW1) (PC.04), the corresponding interrupt is served.

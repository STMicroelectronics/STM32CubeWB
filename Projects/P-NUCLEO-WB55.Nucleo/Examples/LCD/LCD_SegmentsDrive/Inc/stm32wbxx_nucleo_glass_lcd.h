/**
  ******************************************************************************
 * @file    stm32wbxx_nucleo_glass_lcd.h
 * @author  MCD Application Team
 * @brief   Header file for stm32wbxx_nucleo_glass_lcd.c module.
  ******************************************************************************
  * @attention
  *
...
#ifndef __STM32WBXX_NUCLEO_GLASS_LCD_H
#define __STM32WBXX_NUCLEO_GLASS_LCD_H
...
/** @addtogroup STM32WBXX_NUCLEO_GLASS_LCD
  * @{
  */

/* Exported types ------------------------------------------------------------*/

/** @defgroup STM32WBXX_NUCLEO_GLASS_LCD_Exported_Types Exported Types
  * @{
  */
/**
...
/** @defgroup STM32WBXX_NUCLEO_GLASS_LCD_Exported_Constants Exported Constants
  * @{
*/
/**
...
#define LCD_DIGIT4_COM0_SEG_MASK      ~(LCD_SEG6 | LCD_SEG7 | LCD_SEG16 | LCD_SEG17)
#define LCD_DIGIT4_COM1               LCD_COM1
#define LCD_DIGIT4_COM1_SEG_MASK      ~(LCD_SEG6 | LCD_SEG7 | LCD_SEG16 | LCD_SEG17)
#define LCD_DIGIT4_COM2               LCD_COM2
#define LCD_DIGIT4_COM2_SEG_MASK      ~(LCD_SEG6 | LCD_SEG7 | LCD_SEG16 | LCD_SEG17)
#define LCD_DIGIT4_COM3               LCD_COM3
#define LCD_DIGIT4_COM3_SEG_MASK      ~(LCD_SEG6 | LCD_SEG7 | LCD_SEG16 | LCD_SEG17)

#define LCD_DIGIT5_COM0               LCD_COM0
#define LCD_DIGIT5_COM0_SEG_MASK      ~(LCD_SEG8 | LCD_SEG9 | LCD_SEG14 | LCD_SEG15)
#define LCD_DIGIT5_COM1               LCD_COM1
#define LCD_DIGIT5_COM1_SEG_MASK      ~(LCD_SEG8 | LCD_SEG9 | LCD_SEG14 | LCD_SEG15)
#define LCD_DIGIT5_COM2               LCD_COM2
#define LCD_DIGIT5_COM2_SEG_MASK      ~(LCD_SEG8 | LCD_SEG14 | LCD_SEG15)
#define LCD_DIGIT5_COM3               LCD_COM3
#define LCD_DIGIT5_COM3_SEG_MASK      ~(LCD_SEG8 | LCD_SEG14 | LCD_SEG15)
...
#define LCD_DIGIT6_COM2_SEG_MASK      ~(LCD_SEG10 | LCD_SEG12 | LCD_SEG13)
#define LCD_DIGIT6_COM3               LCD_COM3
#define LCD_DIGIT6_COM3_SEG_MASK      ~(LCD_SEG10 | LCD_SEG12 | LCD_SEG13)
...
#define LCD_SEG5          MCU_LCD_SEG30
#define LCD_SEG6          MCU_LCD_SEG6
#define LCD_SEG7          MCU_LCD_SEG28
#define LCD_SEG8          MCU_LCD_SEG8
#define LCD_SEG9          MCU_LCD_SEG24
#define LCD_SEG10         MCU_LCD_SEG10
...
#define LCD_SEG18         MCU_LCD_SEG18
#define LCD_SEG19         MCU_LCD_SEG19
#define LCD_SEG20         MCU_LCD_SEG20
...
#define LCD_SEG5_SHIFT          MCU_LCD_SEG30_SHIFT
#define LCD_SEG6_SHIFT          MCU_LCD_SEG6_SHIFT
#define LCD_SEG7_SHIFT          MCU_LCD_SEG28_SHIFT
#define LCD_SEG8_SHIFT          MCU_LCD_SEG8_SHIFT
#define LCD_SEG9_SHIFT          MCU_LCD_SEG24_SHIFT
#define LCD_SEG10_SHIFT         MCU_LCD_SEG10_SHIFT
#define LCD_SEG11_SHIFT         MCU_LCD_SEG11_SHIFT
#define LCD_SEG12_SHIFT         MCU_LCD_SEG12_SHIFT
#define LCD_SEG13_SHIFT         MCU_LCD_SEG13_SHIFT
#define LCD_SEG14_SHIFT         MCU_LCD_SEG14_SHIFT
#define LCD_SEG15_SHIFT         MCU_LCD_SEG15_SHIFT
#define LCD_SEG16_SHIFT         MCU_LCD_SEG16_SHIFT
#define LCD_SEG17_SHIFT         MCU_LCD_SEG17_SHIFT
#define LCD_SEG18_SHIFT         MCU_LCD_SEG18_SHIFT
#define LCD_SEG19_SHIFT         MCU_LCD_SEG19_SHIFT
#define LCD_SEG20_SHIFT         MCU_LCD_SEG20_SHIFT
#define LCD_SEG21_SHIFT         MCU_LCD_SEG21_SHIFT
#define LCD_SEG22_SHIFT         MCU_LCD_SEG22_SHIFT
#define LCD_SEG23_SHIFT         MCU_LCD_SEG23_SHIFT
...
/** @defgroup STM32WBXX_NUCLEO_LCD_Exported_Functions Exported Functions
  * @{
  */
void BSP_LCD_GLASS_BlinkConfig(LCD_HandleTypeDef *hlcd, uint32_t BlinkMode, uint32_t BlinkFrequency);
void BSP_LCD_GLASS_DisplayChar(LCD_HandleTypeDef *hlcd, uint8_t *ch, Point_Typedef Point, DoublePoint_Typedef Column, uint32_t Position);
...
#endif /* __STM32WBXX_NUCLEO_GLASS_LCD_H */

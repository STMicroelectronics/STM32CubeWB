...
const osThreadAttr_t ThreadSendCoapMsgProcess_attr = {
  .name         = CFG_THREAD_SEND_COAP_MSG_PROCESS_NAME,
  .attr_bits    = CFG_THREAD_SEND_COAP_MSG_PROCESS_ATTR_BITS,
  .cb_mem       = CFG_THREAD_SEND_COAP_MSG_PROCESS_CB_MEM,
  .cb_size      = CFG_THREAD_SEND_COAP_MSG_PROCESS_CB_SIZE,
...
void APP_THREAD_Key_Button1_Action(void)
{
  osThreadFlagsSet(OsTaskSendCoapMsgId, 4);
}

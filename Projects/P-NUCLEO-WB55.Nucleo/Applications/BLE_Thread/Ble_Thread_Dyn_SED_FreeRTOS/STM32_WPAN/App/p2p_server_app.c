...
/* Private variables ---------------------------------------------------------*/
const osThreadAttr_t P2PS_Send_NotificationTask_attr = {
  .name         = CFG_P2PS_SEND_NOTIF_PROCESS_NAME,
  .attr_bits    = CFG_P2PS_SEND_NOTIF_PROCESS_ATTR_BITS,
  .cb_mem       = CFG_P2PS_SEND_NOTIF_PROCESS_CB_MEM,
  .cb_size      = CFG_P2PS_SEND_NOTIF_PROCESS_CB_SIZE,
  .stack_mem    = CFG_P2PS_SEND_NOTIF_PROCESS_STACK_MEM,
  .priority     = CFG_P2PS_SEND_NOTIF_PROCESS_PRIORITY,
  .stack_size   = CFG_P2PS_SEND_NOTIF_PROCESS_STACK_SIZE
};

static osThreadId_t P2PSSendNotifId;
...
/* USER CODE BEGIN PFP */
static void P2PS_Send_NotificationTask(void *);
...
/* USER CODE BEGIN P2PS_APP_Init */
  P2PSSendNotifId = osThreadNew(P2PS_Send_NotificationTask, NULL, &P2PS_Send_NotificationTask_attr);
...
{
  osThreadFlagsSet(P2PSSendNotifId, 1);
}
/* USER CODE END FD */
...
static void P2PS_Send_NotificationTask(void *argument)
{
  UNUSED(argument);

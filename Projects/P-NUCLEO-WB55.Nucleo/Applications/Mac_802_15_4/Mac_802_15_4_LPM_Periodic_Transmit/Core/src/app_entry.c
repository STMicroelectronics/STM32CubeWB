...
extern void APP_LPM_TRANSMIT_MAC_802_15_4_SetupTask(void);
extern void APP_LPM_TRANSMIT_MAC_802_15_4_NodeSrvTask(void);
extern void APP_LPM_TRANSMIT_MAC_802_15_4_NodeDataTask(void);
...
void APP_ENTRY_Init( APP_ENTRY_InitMode_t InitMode )
{
   ...
   */
  UTIL_LPM_SetOffMode(1U << CFG_INIT_TASK, UTIL_LPM_DISABLE);
  Led_Init();
...
static void APPE_UserEvtRx( void * pPayload )
{
  ...
  APP_LPM_TRANSMIT_MAC_802_15_4_Init(APP_MAC_802_15_4_FULL, &Mac_802_15_4_CmdBuffer);
  return;
}
...
void APP_ENTRY_ProcessMsgFromRFCoreTask(void)
{
  ...
  if (CptReceiveMsgFromRFCore != 0U)
  {
    ...
    {
      APP_LPM_TRANSMIT_MAC_802_15_4_Error(ERR_APPLI_REC_MULTI_MSG_FROM_RFCore, 0U);
    }
    else
    {

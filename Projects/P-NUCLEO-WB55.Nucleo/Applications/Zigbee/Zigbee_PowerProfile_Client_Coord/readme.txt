/**
  @page Zigbee_PowerProfile_Client_Coord application
  
  @verbatim
  ******************************************************************************
  * @file    Zigbee/Zigbee_PowerProfile_Client_Coord/readme.txt 
  * @author  MCD Application Team
  * @brief   Description of the Zigbee Power Profile Cluster application as a client  

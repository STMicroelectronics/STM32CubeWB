/**
  @page Zigbee_OnOff_Client_ED application
  
  @verbatim
  ******************************************************************************
  * @file    Zigbee/Zigbee_OnOff_Client_ED/readme.txt 
...
network is created, the End Device periodically sends OnOff Toggle command to the 
OnOff server (1 second delay).

Zigbee_OnOff_Client_ED application is configured to enter Stop mode 2 on IDLE state.
...
- 1 or more STM32WB55xx board loaded with: 
    ...
    - application : Zigbee_OnOff_Client_ED
...
To setup the application :
 ...
 To run the application :
  ...
  a)  Start the first board. It must be the coordinator of the Zigbee network so in this demo application it is
      ...
      Start the second board. This board is configured as Zigbee End Device and will attached to 

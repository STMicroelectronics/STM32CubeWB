/**
  @page Zigbee_OnOff_Server_Coord_ThreadX application
  
  @verbatim
  ******************************************************************************
  * @file    Zigbee/Zigbee_OnOff_Server_Coord_ThreadX/readme.txt 
...
- 1 STM32WB55xx board loaded with: 
    ...
    - application : Zigbee_OnOff_Server_Coord_ThreadX
...
To setup the application :
 ...
 To run the application :
  ...
  a)  Start the first board. It must be the coordinator of the Zigbee network so in this demo application it is
      the device running Zigbee_OnOff_Server_Coord_ThreadX application (Device2 in the above diagram). 

...
- 1 or more STM32WB55xx board (Nucleo or USB dongle) loaded with: 
    - wireless coprocessor : stm32wb5x_Zigbee_FFD_fw.bin
...
@par Hardware and Software environment
  ...
  - For the Zigbee_PowerProfile_Server_Router application, a STM32WB55xx USB dongle can be used.

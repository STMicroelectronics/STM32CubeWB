/**
  ...
  *          (Router part) acting as a Server using a centralized network. 
  ******************************************************************************
  *
...
To setup the application :
 ...
 To run the application :
  ...
  e)  Press the SW1 button again on Device 2 and check for the network information have been updated.

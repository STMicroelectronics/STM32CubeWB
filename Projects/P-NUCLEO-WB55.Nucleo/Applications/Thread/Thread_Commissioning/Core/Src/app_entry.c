...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
{
  ...
  {
  case BUTTON_SW1_PIN:
    APP_DBG("*** Start Configuration Leader ****");
    UTIL_SEQ_SetTask(TASK_CONFIG_LEADER,CFG_SCH_PRIO_1);
    break;
  case BUTTON_SW3_PIN:
    APP_DBG("*** Start Configuration Joiner ****");
    UTIL_SEQ_SetTask(TASK_START_JOINER,CFG_SCH_PRIO_1);
    break;
  default:
    break;
  }

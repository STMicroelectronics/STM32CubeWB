...
/* Size in bytes of the Thread NVM Ram buffer to be stored */
#define CFG_THREAD_NVM_RAM_SIZE_IN_BYTES (4096U)

/* Maximum number of 32-bit data that can be stored in the first bank. */
#define CFG_EE_BANK0_MAX_NB        (CFG_THREAD_NVM_RAM_SIZE_IN_BYTES/4U)

/* Size of the second bank in bytes (can be 0 if the bank is not used).
   It must be a multiple of twice the page size. */
#define CFG_EE_BANK1_SIZE          (0U)
...
#define TASK_NVM             (1U << CFG_TASK_NVM)

...
@note This application is not supported by CubeMx but has been copied from the project BLE_HeartRate_ota generated
      by CubeMx with some modifications in order to be able to download it with the BLE_Ota application.
      The steps to be done to move from the BLE_HeartRate_ota application to the BLE_HeartRate_ota application are :
      - Copy the full folder BLE_HeartRate_ota

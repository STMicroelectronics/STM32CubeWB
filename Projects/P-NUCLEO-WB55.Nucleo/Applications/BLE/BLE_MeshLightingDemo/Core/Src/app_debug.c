...
static void APPD_SetCPU2GpioConfig( void )
{
  ...
  
  {
    ...
    gpio_config.Pin = LL_GPIO_PIN_5;
    __HAL_RCC_GPIOA_CLK_ENABLE();
    __HAL_RCC_C2GPIOA_CLK_ENABLE();
    HAL_GPIO_Init(GPIOA, &gpio_config);
    HAL_GPIO_WritePin(GPIOA, LL_GPIO_PIN_5, GPIO_PIN_RESET);

    gpio_config.Pin = LL_GPIO_PIN_7 | LL_GPIO_PIN_9 | LL_GPIO_PIN_11 | LL_GPIO_PIN_12;
    __HAL_RCC_GPIOB_CLK_ENABLE();
    __HAL_RCC_C2GPIOB_CLK_ENABLE();
    HAL_GPIO_Init(GPIOB, &gpio_config);
    HAL_GPIO_WritePin(GPIOB, 
                      LL_GPIO_PIN_7 | LL_GPIO_PIN_9 | LL_GPIO_PIN_11 | LL_GPIO_PIN_12, 
                      GPIO_PIN_RESET);

    gpio_config.Pin = LL_GPIO_PIN_6| LL_GPIO_PIN_10 | LL_GPIO_PIN_12 | LL_GPIO_PIN_13;
    __HAL_RCC_GPIOC_CLK_ENABLE();
    __HAL_RCC_C2GPIOC_CLK_ENABLE();
    HAL_GPIO_Init(GPIOC, &gpio_config);
    HAL_GPIO_WritePin(GPIOC, 
                      LL_GPIO_PIN_6 | LL_GPIO_PIN_10| LL_GPIO_PIN_12 | LL_GPIO_PIN_13, 
                      GPIO_PIN_RESET);
  }
  return;
}

 ...
 */
#define CFG_GAP_DEVICE_NAME             "PWR"
#define CFG_GAP_DEVICE_NAME_LENGTH      (3)
...
#define CFG_ADV_INT_MODE_FAST 0
#define CFG_ADV_INT_MODE_LP 1
#define CFG_CONN_INT_MODE_FAST 0
#define CFG_CONN_INT_MODE_LP 1
#define TO_SET_DELAY_IN_MS 1000
...
#define ADV_INTERVAL_MIN                  (0x0080)    /*Time = N * 0.625 ms.*/
...
typedef enum
{
  ...
  CFG_TASK_CONN_PARAM_UPDATE_ID,
  CFG_TASK_SEND_DATA_ID,

...
/**
  ******************************************************************************
  * @file    Examples_LL/PWR/PWR_SMPS_64MHZ_MSI_PLL/Src/main.c
...
void Configure_PWR(void)
{
  ...
  /*       With setting of this example (SMPS clock source MSI 16MHz):        */
  ...
  if(LL_RCC_GetSMPSClockSource() != LL_RCC_SMPS_CLKSOURCE_STATUS_MSI)
  {

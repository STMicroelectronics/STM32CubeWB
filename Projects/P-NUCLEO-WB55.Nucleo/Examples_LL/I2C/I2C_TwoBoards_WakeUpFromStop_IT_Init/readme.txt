...
A first program launch, BOARD SLAVE is in Stop 1 mode and BOARD MASTER is waiting User action on User push-button (SW1).
...
@par Directory contents
  ...
  - I2C/I2C_TwoBoards_WakeUpFromStop_IT_Init/Src/stm32wbxx_it.c          Interrupt handlers
  - I2C/I2C_TwoBoards_WakeUpFromStop_IT_Init/Src/main.c                  Main program
  - I2C/I2C_TwoBoards_WakeUpFromStop_IT_Init/Src/system_stm32wbxx.c      STM32WBxx system source file

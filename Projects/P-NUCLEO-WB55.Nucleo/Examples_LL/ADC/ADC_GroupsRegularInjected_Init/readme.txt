...
From the first press on User push-button (SW1), the ADC group injected converts the selected channel
...
@par Directory contents 
  ...
  - ADC/ADC_GroupsRegularInjected_Init/Inc/stm32wbxx_it.h          Interrupt handlers header file
  ...
  - ADC/ADC_GroupsRegularInjected_Init/Src/stm32wbxx_it.c          Interrupt handlers
  - ADC/ADC_GroupsRegularInjected_Init/Src/main.c                  Main program
  - ADC/ADC_GroupsRegularInjected_Init/Src/system_stm32wbxx.c      STM32WBxx system source file

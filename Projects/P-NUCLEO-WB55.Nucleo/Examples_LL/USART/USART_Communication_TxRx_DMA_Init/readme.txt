...
Example execution:
After startup from reset and system configuration, LED2 is blinking quickly and wait User push-button (SW1) action.
...
@par Directory contents 
  ...
  - USART/USART_Communication_TxRx_DMA_Init/Src/stm32wbxx_it.c          Interrupt handlers
  - USART/USART_Communication_TxRx_DMA_Init/Src/main.c                  Main program
  - USART/USART_Communication_TxRx_DMA_Init/Src/system_stm32wbxx.c      STM32WBxx system source file
...
@par Hardware and Software environment
  ...
  - P-NUCLEO-WB55 Set-up
    In order use of Virtual Com port feature of STLINK for connection between P-NUCLEO-WB55 and PC,

...
done using LL unitary services functions for optimization purpose (performance and size). Virtual Com Port
feature of STLINK is used for UART communication between board and PC.
...
@par Directory contents 
  ...
  - USART/USART_Communication_Rx_IT_Continuous_VCP_Init/Src/stm32wbxx_it.c          Interrupt handlers
  - USART/USART_Communication_Rx_IT_Continuous_VCP_Init/Src/main.c                        Main program
  - USART/USART_Communication_Rx_IT_Continuous_VCP_Init/Src/system_stm32wbxx.c      STM32WBxx system source file

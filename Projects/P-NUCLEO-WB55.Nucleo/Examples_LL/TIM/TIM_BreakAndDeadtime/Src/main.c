/**
  ...
  *          to lock the desired parameters, using the STM32WBxx TIM LL API.
  *          Peripheral initialization done using LL unitary services functions.
  ******************************************************************************
  * @attention
  *
  * Copyright (c) PWM(-2021) STMicroelectronics.
  * All rights reserved.
  *
...
/**
  ...
  *         PB.08 (TIM1_CH2N) and PA.06 (TIM1_BKIN).
  * @param  None
  * @retval None
  */
...
__STATIC_INLINE void ConfigureTIMBreakAndDeadtime(void)
{
  ...
  /**********************************/
  /* Enable outputs OC1, OC1N, OC2 and OC2N */

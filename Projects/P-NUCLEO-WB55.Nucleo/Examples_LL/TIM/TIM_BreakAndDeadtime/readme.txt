...
This example is based on the STM32WBxx TIM LL API. The peripheral initialization 
uses LL unitary service functions for optimization purposes (performance and size).

TIM1CLK is fixed to 64 MHz, the TIM1 Prescaler is set to have
...
@par Directory contents 
  ...
  - TIM/TIM_BreakAndDeadtime/Src/stm32wbxx_it.c          Interrupt handlers
  - TIM/TIM_BreakAndDeadtime/Src/main.c                  Main program
  - TIM/TIM_BreakAndDeadtime/Src/system_stm32wbxx.c      STM32WBxx system source file
...
@par Hardware and Software environment
  ...
  - P-NUCLEO-WB55 Set-up
    - Connect the TIM1 pins to an oscilloscope to monitor the different waveforms:
      - TIM1_CH1  PA.08: connected to pin 25 of CN10 connector  
      - TIM1_CH1N PA.07: connected to pin 15 of CN10 connector 
      - TIM1_CH2  PA.09: connected to pin 19 of CN10 connector 
      - TIM1_CH2N PB.08: connected to pin 3 of CN10 connector 

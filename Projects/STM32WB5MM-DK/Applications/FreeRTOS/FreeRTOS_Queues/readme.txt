...
STM32WB5MM-DK's LEDs can be used to monitor the application status:
...
@par Hardware and Software environment
  ...
  - This application runs on STM32WB5MMxx devices.

  - This application has been tested with STM32WB5MM-DK board and can be

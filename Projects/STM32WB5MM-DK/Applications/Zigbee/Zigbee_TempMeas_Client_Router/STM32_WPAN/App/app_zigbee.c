                                               ...
                                               uint16_t in_len)
{
    ...
    switch(attributeId)
    {
      case ZCL_TEMP_MEAS_ATTR_MEAS_VAL:
        ...
        APP_DBG("[From %016llx] - [TEMP MEAS]     %d C",dataIndPtr->src.extAddr,temp_cur);
      ...
      default:
        APP_DBG("[From %016llx] - Reported another attribute %04X",dataIndPtr->src.extAddr,attributeId);
        APP_DBG("");
        break;
    }

/**
  @page Zigbee_TempMeas_Client_Router application
  
  @verbatim
  ******************************************************************************
  * @file    Zigbee/Zigbee_TempMeas_Client_Router/readme.txt 
  * @author  MCD Application Team
  * @brief   Description of the Zigbee Temperature Measurement Cluster application as a client  

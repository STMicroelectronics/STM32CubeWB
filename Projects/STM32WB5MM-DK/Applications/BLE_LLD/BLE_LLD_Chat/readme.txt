...
@par Directory contents 
  ...
  - BLE_LLD/BLE_LLD_Chat/Core/Inc/stm32wb5mm_dk_conf.h    Discovery Module configuration file
...
@par Hardware and Software environment
  ...
  - This application uses two STM32WB5MMxx devices.
  
  - This example has been tested with an STMicroelectronics STM32WB5MM Discovery Kit board
...
In order to make the program work, you must do the following: 
 - Connect 1 STM32WB5MM Discovery Kit board to your PC

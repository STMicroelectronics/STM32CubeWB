...
to the STM32WB35RG_Nucleo Board.
  ...
  |          |                |                      |                                      |
  |          |CN10(Pin21) TX  |______________________|RX                                    | 
  |          |                |                      |                                      |
  |          |                |     RS232 Cable      |                                      |             
  |          |                |                      |                                      |
  |          |CN7(Pin38) RX   |______________________|TX                                    |          
  |          |                |                      |                                      |           
  |          |________________|                      |______________________________________|          
  |                           |                                                
  |                           |                      
  |                           |                      
  |_STM32WB35RG_Nucleo________|                      
...
- When running on two STM32WB35RG_Nucleo boards the same Thread_Cli_Cmd application, and by playing the 
...
@par Hardware and Software environment
  ...
  - This example runs on STM32WB35xx devices (Nucleo board and dongle) 
  
  - This example has been tested with an STMicroelectronics STM32WB35RG_Nucleo 
    board and can be easily tailored to any other supported device 
    and development board.
    
  - On STM32WB35RG_Nucleo, the jumpers must be configured as described
...
In order to make the program work, you must do the following: 
 - Connect an STM32WB35xx_Nucleo board to your PC 

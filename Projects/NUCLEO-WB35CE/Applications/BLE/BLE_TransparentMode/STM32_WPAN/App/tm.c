...
#else
  p_RefTable = (MB_RefTable_t*)((ipccdba<<2) + (0x20008000));
#endif  
...
#else      
      ((TL_CcEvt_t *)(((TL_EvtPacket_t*)&SysLocalCmd)->evtserial.evt.payload))->cmdcode = LHCI_OPCODE_C1_DEVICE_INF;
      ((TL_EvtPacket_t*)&SysLocalCmd)->evtserial.evt.plen = TL_EVT_HDR_SIZE + sizeof(LHCI_C1_Device_Information_ccrp_t);
      ((TL_CcEvt_t *)(((TL_EvtPacket_t*)&SysLocalCmd)->evtserial.evt.payload))->payload[0] = 0x00;
#endif      
...
#else
  p_ref_table = (MB_RefTable_t*)((ipccdba<<2) + (0x20008000));
#endif  

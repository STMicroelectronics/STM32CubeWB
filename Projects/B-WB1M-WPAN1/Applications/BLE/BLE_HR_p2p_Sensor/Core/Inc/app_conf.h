...
#define BLE_CFG_HRS_ENERGY_RR_INTERVAL_FLAG              (1)     /* Number of RR interval, shall be lower than HRS_MAX_NBR_RR_INTERVAL_VALUES*/
...
#define PUSH_BUTTON_SW1_EXTI_IRQHandler     EXTI1_IRQHandler

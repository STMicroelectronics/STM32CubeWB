...
{
  5, AD_TYPE_COMPLETE_LOCAL_NAME, 'W', 'B', '1', 'M',  /* Complete name */
  3, AD_TYPE_16_BIT_SERV_UUID_CMPLT_LIST, 0x0D, 0x18,
  15, AD_TYPE_MANUFACTURER_SPECIFIC_DATA, 0x30, 0x00, 0x02 /* SDK v2 */, 0x83 /* WB1M - CEB */, 0x99 /* F.ID */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */,
};
    ...
    case AD_TYPE_MANUFACTURER_SPECIFIC_DATA:
      {
        ...
        p_adv_data[i+5] = BOARD_ID_DK_WB1M;//BOARD_ID_DK_WB1M; /* Board ID */

/**
  ******************************************************************************
  * @file    b_wb1m_wpan1_env_sensors_ex.h
  * @author  MEMS Software Solutions Team
  * @brief   This file contains the common defines and functions prototypes for
  *          the b_wb1m_wpan1_env_sensors_ex.c driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef B_WB1M_WPAN1_ENV_SENSOR_EX_H
#define B_WB1M_WPAN1_ENV_SENSOR_EX_H
...
/** @addtogroup B_WB1M_WPAN1_ENV_SENSOR_EX B-WB1M-WPAN1 ENV SENSOR EX
  * @{
  */

/** @addtogroup B_WB1M_WPAN1_ENV_SENSOR_EX_Exported_Functions B-WB1M-WPAN1 ENV SENSOR EX Exported Functions
  * @{
  */

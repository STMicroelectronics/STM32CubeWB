/**
  ...
  *          available on STM32WB5MM-DK board (MB1292) from
  *          STMicroelectronics.
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STM32WB5MM_DK_BUS STM32WB5MM-DK BUS
  * @{
  */

/** @defgroup STM32WB5MM_DK_BUS_Private_Defines STM32WB5MM-DK BUS Private Defines
  * @{
  */
...
/** @defgroup STM32WB5MM_DK_BUS_Private_Types STM32WB5MM-DK BUS Private Types
  * @{
  */
typedef struct
{
...
/** @defgroup STM32WB5MM_DK_BUS_Private_Constants STM32WB5MM-DK BUS Private Constants
  * @{
  */
...
/** @defgroup STM32WB5MM_DK_BUS_Private_Variables STM32WB5MM-DK BUS Private Variables
  * @{
  */
...
/** @defgroup STM32WB5MM_DK_BUS_Exported_Variables STM32WB5MM-DK BUS Exported Variables
  * @{
  */
...
/** @defgroup STM32WB5MM_DK_BUS_Private_Function_Prototypes STM32WB5MM-DK BUS Private Function Prototypes
  * @{
  */
...
/** @defgroup STM32WB5MM_DK_BUS_Exported_Functions STM32WB5MM-DK BUS Exported Functions
  * @{
  */
...
/** @defgroup STM32WB5MM_DK_BUS_Private_Functions STM32WB5MM-DK BUS Private Functions
  * @{
  */
